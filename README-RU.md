...
- ⌨️ **Маппинг клавиш**: Настраивайте тапы, джойстик, свайпы и прокрутку прямо на встроенном зеркале
- 🎛️ **Встроенная панель управления**: Компактная боковая панель с перетаскиваемыми элементами: поворот, скриншот, приложения, файлы и терминал
