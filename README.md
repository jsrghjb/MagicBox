...
- ⌨️ **Keyboard Mapping**: Configure touch, joystick, swipe, and scroll mappings directly on the embedded mirror
- 🎛️ **Integrated Control Bar**: Compact, draggable sidebar with reorderable controls: rotation, screenshot, apps, files, and terminal
